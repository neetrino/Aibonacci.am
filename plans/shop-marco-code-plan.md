...
**Bitrix (կարևոր).** Սինքը հավելվածից **միշտ ստեղծում է նոր Scrum epic-ներ** — կրկնումից խուսափելու համար մինչև սինք ստուգեք պորտալում արդեն գոյություն ունեցող epic-ների անունները, կամ համաձայնեցրեք դեդուպ լոգիկա։ YAML-ը և sync-ը — **միայն ձեր հաստատումից հետո** (workspace կանոններ)։
